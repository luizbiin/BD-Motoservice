...
CREATE TABLE `motoboy` (
  `CodMotoboy` smallint(6) NOT NULL AUTO_INCREMENT,
  `Sexo` enum('M','F') NOT NULL,
  `NomeMotoboy` varchar(35) NOT NULL,
  `DataNasc` date NOT NULL,
  `CPF` int(11) NOT NULL,
  `CodExp` int(11) NOT NULL,
  PRIMARY KEY (`CodMotoboy`),
  KEY `CodExp` (`CodExp`),
  CONSTRAINT `motoboy_ibfk_1` FOREIGN KEY (`CodExp`) REFERENCES `expediente` (`CodExp`) ON UPDATE CASCADE
...
-- Dump completed on 2019-07-22 15:42:19
